    ...
    return (
        <div className="flex flex-col h-screen">
            <div className="flex-1 relative cursor-pointer">
                ...
                <div
                    className="absolute top-4 left-4 bg-white rounded-lg shadow-lg w-100 max-h-[90%] overflow-y-auto z-10 flex flex-col justify-start">

                    <div className="flex  flex-col justify-start float-left">
                        <Label className={' font-bold text-2xl'}>Edit Map</Label>
                        <div className="flex  flex-col justify-start text-left">
                            <Tabs defaultValue="place-node" value={activeTab} onValueChange={setActiveTab}
                                ...
                                <div className={'w-80 flex flex-col'}>
                                    <TabsContent value="place-node" className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-2 border rounded-md p-2 max-h-40 overflow-y-auto">
                                                    {availableDepartments.length > 0 ? (
                                                        ...
                                                        <p className="text-gray-500 text-sm">No departments
                                                            available</p>
                                                    )}
                                                </div>
                                            </div>
                                        ...
                                        <Button onClick={saveNode} disabled={!coordinates || !nodeType}
                                                className={'w-full'}>Save Node</Button>
                                        ...
                                        <div className="mt-6 pt-4 border-t border-gray-200">
                                            ...
                                            <Button onClick={saveEdge} disabled={edgeNodes.length != 2}
                                                    className="w-full mt-2">Save Edge</Button>
                                        </div>
                                    </TabsContent>
                                    ...
                                    <TabsContent value="edit-node" className="space-y-4">
                                        <div className="bg-gray-100 p-3 rounded-md">
                                            ...
                                            {(nodes !== '') ? (
                                                ...
                                                <p className="text-sm text-gray-500">Click on a node to select it for
                                                    editing</p>
                                            )}
                                        </div>
                                        ...
                                        <Button onClick={editNode} disabled={!nodes} className="w-full">Save
                                            Changes</Button>
                                    </TabsContent>
                                    <Button onClick={resetMap} variant="ghostDestructive" className="w-full mt-4">Reset
                                        Map to Default</Button>
                                </div>
                            </Tabs>
                        </div>
                    </div>
