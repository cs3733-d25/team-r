...
export const rawDirectoryItems: RawDirectoryItem[] = [
    ...
    {name: 'Bridge Clinic, Dushku-Palandijian', floorNumber: 1, building: "WOMENS"},
    ...
    {name: 'Ambulatory Radiology (X-Ray and CT Scan)', floorNumber: 2, building: "WOMENS"},
    ...
    {name: 'Phlebotomy, Outpatient', floorNumber: 2, building: "WOMENS"},
    {name: 'Brigham Circle Medical Associates', floorNumber: 2, building: "WOMENS"},
    ...
    {name: 'Center for Chest Diseases', floorNumber: 2, building: "WOMENS"},
    ...
    {name: 'Dana-Farber Cancer Inpatient Hospital', floorNumber: 6, building: "WOMENS"},
