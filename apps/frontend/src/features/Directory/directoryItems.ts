...
export const rawDirectoryItems: RawDirectoryItem[] = [
    ...
    {name: "Ophthalmology", floorNumber: 3, building: "PATRIOT_PLACE_22"},
    {name: "Optometry", floorNumber: 3, building: "PATRIOT_PLACE_22"},
    {name: "Pulmonology", floorNumber: 3, building: "PATRIOT_PLACE_22"},
    {name: "Rheumatology", floorNumber: 3, building: "PATRIOT_PLACE_22"},
    ...
    {name: 'Endocrinology/Diabetes/Hematology', floorNumber: 5, building: "FAULKNER"},
    ...
    {name: 'Admitting', floorNumber: 1, building: "WOMENS"},
    {name: 'Bridge Clinic, Dushku-Palandjian', floorNumber: 1, building: "WOMENS"},
    {name: 'Emergency', floorNumber: 1, building: "WOMENS"},
    {name: 'Brigham Circle Medical Associates (BCMA)', floorNumber: 2, building: "WOMENS"},
    {name: 'Obstetrics Admitting', floorNumber: 1, building: "WOMENS"},
    {name: 'Brigham Medical Specialties / Schuster Transplant', floorNumber: 2, building: "WOMENS"},
    {name: 'Center for Weight Management & Metabolic Surgery', floorNumber: 2, building: "WOMENS"},
    {name: 'Endocrine – Diabetes', floorNumber: 2, building: "WOMENS"},
    {name: 'Gastroenterology & Hepatology', floorNumber: 2, building: "WOMENS"},
    {name: 'Genetics & Genomics Medicine', floorNumber: 2, building: "WOMENS"},
    {name: 'Infectious Disease', floorNumber: 4, building: "WOMENS"},
    {name: 'Kidney / Pancreas Transplant', floorNumber: 2, building: "WOMENS"},
    {name: 'Kidney Medicine', floorNumber: 2, building: "WOMENS"},
    {name: 'Nutrition', floorNumber: 2, building: "WOMENS"},
    {name: 'Ambulatory Radiology (X-ray & CT scan)', floorNumber: 2, building: "WOMENS"},
    {name: 'Breast Imaging, Lee Bell Center', floorNumber: 2, building: "WOMENS"},
    ...
    {name: 'Chest Diseases, Center for', floorNumber: 2, building: "WOMENS"},
    {name: 'Comprehensive Breast Health Center', floorNumber: 2, building: "WOMENS"},
    {name: 'Connors Center for Women’s Health', floorNumber: 3, building: "WOMENS"},
    {name: 'Dental Group / Oral Medicine', floorNumber: 2, building: "WOMENS"},
    {name: 'Dialysis', floorNumber: 3, building: "WOMENS"},
    {name: 'Ear, Nose and Throat (ENT)', floorNumber: 2, building: "WOMENS"},
    {name: 'Echocardiography', floorNumber: 2, building: "WOMENS"},
    {name: 'Electrophysiology', floorNumber: 2, building: "WOMENS"},
    {name: 'Endoscopy', floorNumber: 2, building: "WOMENS"},
    {name: 'Gynecologic Oncology', floorNumber: 3, building: "WOMENS"},
    {name: 'High Risk Obstetric Ultrasound', floorNumber: 3, building: "WOMENS"},
    {name: 'Infusion', floorNumber: 0, building: "WOMENS"},
    {name: 'Infertility & Reproductive Surgery', floorNumber: 3, building: "WOMENS"},
    {name: 'International Patient Center / Executive Health', floorNumber: 2, building: "WOMENS"},
    {name: 'Jen Center for Primary Care', floorNumber: 2, building: "WOMENS"},
    {name: 'Lung Center', floorNumber: 2, building: "WOMENS"},
    {name: 'Mammography', floorNumber: 2, building: "WOMENS"},
    ...
    {name: 'Neurology', floorNumber: 1, building: "WOMENS"},
    {name: 'Neurosurgery', floorNumber: 1, building: "WOMENS"},
    {name: 'Orthopedics', floorNumber: 2, building: "WOMENS"},
    {name: 'Plastic & Reconstructive Surgery', floorNumber: 2, building: "WOMENS"},
    {name: 'Podiatry', floorNumber: 2, building: "WOMENS"},
    {name: 'Rehabilitation Services PT / OT', floorNumber: 1, building: "WOMENS"},
    {name: 'Rheumatology', floorNumber: 2, building: "WOMENS"},
    {name: 'Thoracic Surgery Clinic', floorNumber: 2, building: "WOMENS"},
    {name: 'Urology', floorNumber: 3, building: "WOMENS"},
    {name: 'Watkins Cardiovascular Clinic', floorNumber: 2, building: "WOMENS"},
    {name: 'Weiner Center for Pre-Op Evaluation', floorNumber: 2, building: "WOMENS"},
    {name: 'Wound Care Center', floorNumber: 1, building: "WOMENS"},
    {name: 'Connors Center', floorNumber: 5, building: "CONNORS"},
    {name: 'Dana-Farber Cancer Inpatient Hospital', floorNumber: 6, building: "DFCI"},
    {name: 'Shapiro Cardiovascular', floorNumber: 6, building: "SHAPIRO"},
    {name: 'Braunwald Tower Building', floorNumber: 3, building: "BRAUNWALD"},
    {name: 'Cardiovascular Imaging Center', floorNumber: -2, building: "WOMENS"},
    {name: 'Cath Lab', floorNumber: -2, building: "WOMENS"},
    {name: 'Cross-Sectional Interventional Radiology', floorNumber: -1, building: "WOMENS"},
    {name: 'Day Surgery Check-in / Pre-Op', floorNumber: -1, building: "WOMENS"},
    {name: 'Medical Records / Film Library', floorNumber: -1, building: "WOMENS"},
    {name: 'Nuclear Medicine & Molecular Imaging', floorNumber: -1, building: "WOMENS"},
    {name: 'Outpatient X-ray', floorNumber: -1, building: "WOMENS"},
    {name: 'PACU', floorNumber: -1, building: "WOMENS"},
    {name: 'Phlebotomy, Outpatient', floorNumber: 0, building: "WOMENS"},
    ...
    {name: 'Bornstein Amphitheater', floorNumber: 2, building: "WOMENS"},
    {name: "Boston Children's Hospital, Bridge to", floorNumber: 2, building: "BCH"},
    {name: 'Bretholtz Family Center', floorNumber: 1, building: "WOMENS"},
    {name: 'Cafeteria', floorNumber: 2, building: "WOMENS"},
    {name: 'Carrie Hall Conference Room', floorNumber: 2, building: "WOMENS"},
    {name: 'Chapel, Multi-Faith', floorNumber: 1, building: "WOMENS"},
    {name: 'Dana-Farber Cancer Institute, Bridge to', floorNumber: 3, building: "DFCI"},
    {name: 'Dana-Farber Cancer Instit. Inpatient Hospital', floorNumber: 6, building: "DFCI"},
    {name: 'Kraft Blood Donor Center', floorNumber: 3, building: "WOMENS"},
    {name: 'Patient Financial Registration', floorNumber: 2, building: "WOMENS"},
