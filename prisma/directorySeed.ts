...
async function main() {
    await client.directory.createMany({
        data: [
            ...
            {name: "Thoriacic Surgery", floorNumber: 3, building: "Patriot Place 20"},
            ...
            {name: "X-Rat Suite", floorNumber: 3, building: "Patriot Place 20"},
            ...
            {name: "Opthalmology", floorNumber: 3, building: "Patriot Place 22"},
            {name: "Optometry", floorNumber: 3, building: "Patriot Place 22"},
            {name: "Pulmonology", floorNumber: 3, building: "Patriot Place 22"},
            {name: "Rhematology", floorNumber: 3, building: "Patriot Place 22"},
