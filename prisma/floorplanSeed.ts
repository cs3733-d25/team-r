...
async function main() {
    ...
    await prisma.node.createMany({
        data: [
            {nodeID: 'valetParking20', nodeType: NodeType.parking, building: Building.PATRIOT_PLACE_20, floor: 1, xcoord: 594.87, ycoord: 43.05, longName: 'Valet Parking 20 Patriot', shortName: 'Valet Parking 20 Patriot',},
            {nodeID: 'patientParking20', nodeType: NodeType.parking, building: Building.PATRIOT_PLACE_20, floor: 1, xcoord: 166.45, ycoord: 36.50, longName: 'Patient Parking 20 Patriot', shortName: 'Patient Parking 20 Patriot',},
            {nodeID: 'extendedParking20', nodeType: NodeType.parking, building: Building.PATRIOT_PLACE_20, floor: 1, xcoord: 125.94, ycoord: 265.92, longName: 'Extended Patient Parking 20 Patriot', shortName: 'Extended Patient Parking 20 Patriot',},
        ...
        await prisma.node.createMany({
            data: [
                ...
                {nodeID: 'extendedParking22', nodeType: NodeType.parking, building: Building.PATRIOT_PLACE_22, floor: 1, xcoord: 128.70, ycoord: 226.15, longName: 'Extended Patient Parking 22 Patriot', shortName: 'Extended Patient Parking 22 Patriot',},
