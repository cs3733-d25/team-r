    ...
    await client.node.createMany({
        ...
        await client.node.createMany({
            data: [
                ...
                {nodeID: '300.10', nodeType: 'Elevator', building: 'Patriot Place 20'0, floor: 3, xcoord: 191.74, ycoord: 757.50, longName: '3rd Floor Elevator', shortName: '3rd Floor Elevator'}
            ],
            skipDuplicates: true
        });
        ...
        await client.node.createMany({
            data: [
                {nodeID: 'valetParking22', nodeType: NodeType.parking, building: 'Patriot Place 22', floor: 1, xcoord: 576.44, ycoord: 35.10, longName: 'Valet Parking 22 Patriot', shortName: 'Valet Parking 22 Patriot',},
                {nodeID: 'patientParking22', nodeType: NodeType.parking, building: 'Patriot Place 22', floor: 1, xcoord: 217.98, ycoord: 221.99, longName: 'Patient Parking 22 Patriot', shortName: 'Patient Parking 22 Patriot',},
                {nodeID: 'extendedParking22', nodeType: NodeType.parking, building: 'Patriot Place 22', floor: 1, xcoord: 128.70, ycoord: 226.15, longName: 'Extended Patient Parking 22 Patriot', shortName: 'Extended Patient Parking 22 Patriot',},
        ...
        await client.node.createMany({
            data: [
                ...
                {nodeID: '3000C', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 3, xcoord: 444.25, ycoord: 344.00, longName: 'Copy 3000C', shortName: 'Copy 3000C'},
                {nodeID: '3E', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 3, xcoord: 466.88, ycoord: 345.00, longName: 'Corridor 3E', shortName: 'Corridor 3E'},
                {nodeID: '3001', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 3, xcoord: 466.63, ycoord: 432.00, longName: 'Touchdown 3001', shortName: 'Touchdown 3001'},
                {nodeID: '3000A', nodeType: NodeType.reception, building: 'Patriot Place 22', floor: 3, xcoord: 418.63, ycoord: 419.25, longName: 'Check-In 3000A', shortName: 'Check-In 3000A'},
                ...
                {nodeID: '3B', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 3, xcoord: 438.13, ycoord: 592.50, longName: 'Corridor 3B', shortName: 'Corridor 3B'},
                {nodeID: '3000B', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 3, xcoord: 436.13, ycoord: 643.75, longName: 'Waiting 3000B', shortName: 'Waiting 3000B'},
                {nodeID: '3104', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 3, xcoord: 595.13, ycoord: 639.00, longName: 'EQ Alcohol 3104', shortName: 'EQ Alcohol 3104'},
                {nodeID: '3S', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 3, xcoord: 595.13, ycoord: 733.25, longName: 'Corridor 3S', shortName: 'Corridor 3S'},
                {nodeID: '3112', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 3, xcoord: 645.88, ycoord: 732.50, longName: 'Exam 3112', shortName: 'Exam 3112'},
                ...
                {nodeID: '307', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 3, xcoord: 275.38, ycoord: 693.50, longName: 'Bridge 307', shortName: 'Bridge 307'}
            ],
            skipDuplicates: true
        });
        ...
        await client.node.createMany({
            data: [
                { nodeID: 'checkIn4000B', nodeType: NodeType.reception, building: 'Patriot Place 22', floor: 4, xcoord: 319.25, ycoord: 654.50, longName: 'rightCheckIn', shortName: 'rightCheckIn'},
                { nodeID: 'waiting4000', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 4, xcoord: 299.25, ycoord: 579.50, longName: 'rightEntranceWaiting', shortName: 'rightEntranceWaiting'},
                { nodeID: 'rightWaitingHallway', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 4, xcoord: 250.25, ycoord: 633.50, longName: 'rightWaitingHallway', shortName: 'rightWaitingHallway'},
                { nodeID: 'rightEntranceHallway', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 4, xcoord: 353.25, ycoord: 655.50, longName: 'rightEntranceHallway', shortName: 'rightEntranceHallway'},
                ...
                { nodeID: 'corridor4R', nodeType: NodeType.hallway, building: 'Patriot Place 22', floor: 4, xcoord: 468.75, ycoord: 653.50, longName: 'checkOutHallway', shortName: 'checkOutHallway'},
                { nodeID: 'checkOutWait4083', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 4, xcoord: 470.25, ycoord: 615.00, longName: 'checkOutWait', shortName: 'checkOutWait'},
                { nodeID: 'checkOut4090', nodeType: NodeType.other, building: 'Patriot Place 22', floor: 4, xcoord: 497.25, ycoord: 708.00, longName: 'checkOut', shortName: 'checkOut'}
            ],
            skipDuplicates: true
        });
